/* JFast v2.0.2 | (c) by jl15988 | Updated 2020-10-23 */ !(function(j) {
	...
	jt.n = jt.prototype = {
		...
		typeArray: function() {
			return jt.typeArray(this);
		},
		inputRegAlert: function(iden, alertInfo) {
			return jt.inputRegAlert(this, iden, alertInfo);
		},
	...
	jt.e({
		 ...
		 * @param {Object} alertInfo 提示信息
		 */
		checkInputValueAlert: function(sor, value, alertInfo) {
			var res;
			if (!sor.length) {
				sor = $(sor);
			};
